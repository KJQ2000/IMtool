...
def cancelbooking(book_id):
    if book_id:
        ...
        db.update(table= 'book_payment', set_columns=['bp_status'],set_values=['CANCELLED'],where=f"bp_book_id='{book_id}'")
        
        db.update(table= 'booking',set_columns=['book_status'],set_values=['CANCELLED'],where=f"book_id='{book_id}'")
        
        db.update(table= 'stock', set_columns=['stk_status','stk_book_id','stk_weight_book','stk_gold_book','stk_labor_book','stk_book_price'], set_values=['IN STOCK',None,None,None,None,None],where=f"stk_book_id='{book_id}'")
